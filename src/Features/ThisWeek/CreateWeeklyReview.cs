...
/// <summary>
/// Creates a weekly review entry by aggregating daily entries.
/// </summary>
public static class CreateWeeklyReview
{
    /// <summary>
    /// Command to create a weekly review entry by aggregating daily entries.
    /// </summary>
    public sealed record Command : IRequest<Result<WeeklyEntry>>
    {
        /// <summary>
    ...
    {
        private readonly IMemoryStorageProvider _storage = storage;
        ...
        /// <summary>
        /// Handles the CreateWeeklyReview.Command to create a new weekly review.
        /// </summary>
            ...
            CancellationToken cancellationToken)
        {
            ...
            Result<IReadOnlyList<TemplateInfo>> templatesResult = await _templateProvider.ListTemplatesAsync(
                filterByType: TemplateType.Weekly,
            ...
            try
            {
                completionResult = await llmProvider.GenerateCompletionAsync(prompt, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
        ...
        private static Result<WeeklyEntry> ValidateCommand(Command request)
        {
