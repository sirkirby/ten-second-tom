...
public sealed class ConfigurationTests
{
    ...
    public void Configuration_LoadsDefaultsFromAppSettings()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["TenSecondTom:Storage:RootDirectory"] = "./.memory",
        ...
        // Act
        string? storageDirectory = configuration["TenSecondTom:Storage:RootDirectory"];
        string? llmProvider = configuration["TenSecondTom:Llm:Provider"];

        // Assert
        storageDirectory.Should().NotBeNullOrEmpty("default storage directory should be configured");
    ...
    public void Configuration_ValidatesRequiredSettings()
    {
        ...
        // Assert
        storageDirectory.Should().BeNull("missing required settings should be null");
