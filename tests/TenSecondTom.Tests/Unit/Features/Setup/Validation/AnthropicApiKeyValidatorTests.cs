...
public sealed class AnthropicApiKeyValidatorTests
{
    ...
    [Fact(Skip = "Requires mocking Anthropic SDK - complex integration")]
    public void ValidateNetworkAsync_WithValidKey_ReturnsSuccess()
    {
        // This test requires mocking the Anthropic SDK's AnthropicClient which is complex
        // The actual Anthropic SDK uses internal clients that are difficult to mock
    ...
    {
        // This test requires mocking the Anthropic SDK's AnthropicClient
    ...
    [Fact(Skip = "Requires complex Anthropic SDK mocking for retry simulation")]
    public void ValidateNetworkAsync_WithRetries_UsesExponentialBackoff()
    {
        ...
        // Requires mocking Anthropic AnthropicClient to throw exceptions
        // Better suited for integration tests
    }
    ...
    [Fact(Skip = "Requires Anthropic SDK mocking - integration test")]
    public void ValidateNetworkAsync_LogsAttempts()
    {
        // This test would verify debug logging for each attempt
        // Requires actual or mocked Anthropic API responses
    }
